...
export default function LoginScreen({onLogin}:{onLogin:(nome:string,role:'lancadora'|'gestora'|'entregador')=>void}) {
  ...
  return (
    <div style={{minHeight:'100vh',background:'#F7F7F3',display:'flex',alignItems:'stretch',fontFamily:"'DM Sans',sans-serif"}}>
      <div className="login-aside" style={{flex:'1 1 50%',background:'#173A38',padding:'clamp(2rem, 7vw, 6rem)',display:'flex',flexDirection:'column',justifyContent:'space-between',color:'#fff',position:'relative',overflow:'hidden'}}>
        <div style={{position:'absolute',width:420,height:420,borderRadius:'50%',border:'1px solid rgba(255,255,255,.10)',right:-180,top:-160}}/>
        <div style={{position:'absolute',width:300,height:300,borderRadius:'50%',border:'1px solid rgba(242,161,125,.22)',left:-180,bottom:-130}}/>
        <div style={{position:'relative'}}>
          <div style={{display:'flex',alignItems:'center',gap:12,marginBottom:'clamp(3.5rem, 11vh, 8rem)'}}>
            <div style={{width:42,height:42,borderRadius:12,background:'#F2A17D',display:'flex',alignItems:'center',justifyContent:'center',overflow:'hidden'}}>
            ...
            <div><p style={{fontFamily:"'Space Grotesk',sans-serif",fontSize:21,fontWeight:700,letterSpacing:'-.05em',margin:0}}>servis</p><p style={{fontSize:9,fontWeight:700,color:'#A9C0BB',letterSpacing:'.18em',textTransform:'uppercase',margin:'2px 0 0'}}>operação</p></div>
          </div>
          <p style={{fontSize:11,fontWeight:700,letterSpacing:'.16em',textTransform:'uppercase',color:'#F2A17D',margin:'0 0 16px'}}>Painel interno</p>
          ...
          <p style={{fontSize:15,lineHeight:1.65,color:'#B9CCC8',maxWidth:430,margin:'24px 0 0'}}>Acompanhe orçamentos, pagamentos, entregas e notas fiscais em um único lugar.</p>
        </div>
        <p style={{position:'relative',fontSize:11,color:'#7F9C96',margin:0}}>Servis Empreendimentos · acesso restrito</p>
      </div>
      <div style={{flex:'1 1 50%',display:'flex',alignItems:'center',justifyContent:'center',padding:'2rem'}}>
        <div style={{width:'100%',maxWidth:410}}>
          <div style={{marginBottom:32}}>
            <p style={{fontSize:11,fontWeight:700,color:'#1D6863',textTransform:'uppercase',letterSpacing:'.15em',margin:'0 0 10px'}}>Bem-vinda de volta</p>
            <h2 style={{fontFamily:"'Space Grotesk',sans-serif",fontSize:30,letterSpacing:'-.05em',color:'#162827',margin:0}}>Entre no seu workspace</h2>
            <p style={{fontSize:13,color:'#71817E',margin:'10px 0 0'}}>Use suas credenciais para continuar.</p>
          </div>
          <div style={{background:'#fff',border:'1px solid #E7EBE7',borderRadius:18,padding:'1.5rem',boxShadow:'0 14px 34px rgba(22,40,39,.07)',display:'flex',flexDirection:'column',gap:16}}>
            ...
            {erro&&<p style={{fontSize:12,color:'#C85E4A',background:'#FFF1EC',borderRadius:8,padding:'9px 10px',textAlign:'center',margin:0}}>{erro}</p>}
          ...
          <p style={{fontSize:11,color:'#9AA6A3',textAlign:'center',margin:'18px 0 0'}}>Se você não possui acesso, procure a gestão.</p>
        </div>
      </div>
    </div>
  )
