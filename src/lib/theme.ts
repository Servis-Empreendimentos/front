export const SIDEBAR_BG  = '#8C8C8C'
export const SIDEBAR_BG2 = '#A0B3AC'
export const ACCENT      = '#8BA59A'
export const ACCENT_LT   = '#708277'

export const s = {
  page:    { minHeight:'100vh', display:'flex', fontFamily:"'DM Sans',sans-serif", background:'#F7F8F7', color:'#626262' },
  ...
  btnGrn:  { display:'flex', alignItems:'center', gap:6, background:'#8BA59A', color:'#fff', border:'none', padding:'.62rem 1rem', borderRadius:9, fontSize:13, fontWeight:700, cursor:'pointer', boxShadow:'0 5px 13px rgba(127,156,147,.18)' },
  ...
  kpi:     { background:'#fff', border:'1px solid #E2E6E4', borderRadius:14, padding:'1.05rem 1.1rem', position:'relative' as const, overflow:'hidden', boxShadow:'0 2px 10px rgba(96,100,99,.045)' },
  card:    { background:'#fff', border:'1px solid #E2E6E4', borderRadius:16, overflow:'hidden', boxShadow:'0 2px 10px rgba(96,100,99,.045)', marginBottom:'1.35rem' },
  ...
  footer:  { background:'#fff', borderTop:'1px solid #E2E6E4', padding:'.8rem clamp(1rem, 3vw, 2.75rem)', display:'flex', justifyContent:'space-between', alignItems:'center' },
}

export const PIPE_COLORS: Record<string,string> = {
  orcamento_aprovado:'#969696', em_tratativa:'#858585', orcamento_fechado:'#707070',
  pagamento_realizado:'#708277', entrega_programada:'#8E9994', mercadoria_recebida:ACCENT_LT, nf_recebida:'#626262',
}
